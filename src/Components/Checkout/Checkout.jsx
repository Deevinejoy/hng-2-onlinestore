  ...
  return (
    ...
    <div className='payment'>
      ...
      <form className='payment-card'>
        <label htmlFor='card-number'>Credid card Number</label>
        <input id='card-number' type="tel" placeholder='xxxx xxxx xxxx xxxx' inputMode='numeric'  required />

        <label htmlFor='card-name'>Card Name</label>
        <input id='card-name' type="text" placeholder="Holder's Name" />

        <div className='card-det'>
          <form>
          <label htmlFor='expiry'>Expiry date</label>
          <input id='expiry' type="tel" placeholder="xx/xx"  inputMode='numeric'/>
            
          </form>
          <form>
          <label htmlFor='cvv'>CVV</label>
          <input id='cvv' type="tel" placeholder="xxx"  inputMode='numeric'/>
